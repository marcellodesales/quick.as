...
exports.video = function(req, res) {
    ...
    client.query("SELECT casts.*, users.username FROM casts INNER JOIN users ON (casts.ownerid = users.userid) WHERE lower(uniqueid) = $1 AND published = true", [video_entry.toLowerCase()], function(err, result){
    	client.end();
